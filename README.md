Generated with [Bati](https://batijs.dev) ([version 258](https://www.npmjs.com/package/create-bati/v/0.0.258)) using this command:

```sh
pnpm create bati --solid --daisyui --tailwindcss --hono --vercel --eslint
```
